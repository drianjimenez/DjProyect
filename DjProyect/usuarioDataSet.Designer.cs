...
namespace DjProyect {
    ...
    public partial class usuarioDataSet : global::System.Data.DataSet {
        ...
        public partial class usuarioDataTable : global::System.Data.TypedTableBase<usuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usuarioRow AddusuarioRow(string usuario, string contrasena, string nombre, string estado, int sucursal) {
        ...
        public partial class usuarioRow : global::System.Data.DataRow {
            ...
            public int sucursal {
                get {
                    try {
                        return ((int)(this[this.tableusuario.sucursalColumn]));
                    }
                ...
                set {
                    this[this.tableusuario.sucursalColumn] = value;
                }
            }
            ...
            public bool IssucursalNull() {
                return this.IsNull(this.tableusuario.sucursalColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetsucursalNull() {
                this[this.tableusuario.sucursalColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace DjProyect.usuarioDataSetTableAdapters {
    ...
    public partial class usuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[usuario] WHERE (([usuario] = @Original_usuario) AND ([contrasena] = @Original_contrasena) AND ([nombre] = @Original_nombre) AND ([estado] = @Original_estado) AND ((@IsNull_sucursal = 1 AND [sucursal] IS NULL) OR ([sucursal] = @Original_sucursal)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuario] ([usuario], [contrasena], [nombre], [estado], [sucurs" +
                "al]) VALUES (@usuario, @contrasena, @nombre, @estado, @sucursal);\r\nSELECT usuari" +
                "o, contrasena, nombre, estado, sucursal FROM usuario WHERE (usuario = @usuario)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[usuario] SET [usuario] = @usuario, [contrasena] = @contrasena, [nombre] = @nombre, [estado] = @estado, [sucursal] = @sucursal WHERE (([usuario] = @Original_usuario) AND ([contrasena] = @Original_contrasena) AND ([nombre] = @Original_nombre) AND ([estado] = @Original_estado) AND ((@IsNull_sucursal = 1 AND [sucursal] IS NULL) OR ([sucursal] = @Original_sucursal)));
SELECT usuario, contrasena, nombre, estado, sucursal FROM usuario WHERE (usuario = @usuario)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT usuario, contrasena, nombre, estado, sucursal FROM dbo.usuario";
        ...
        public virtual int Delete(string Original_usuario, string Original_contrasena, string Original_nombre, string Original_estado, global::System.Nullable<int> Original_sucursal) {
            ...
            if ((Original_sucursal.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_sucursal.Value));
            }
            else {
        ...
        public virtual int Insert(string usuario, string contrasena, string nombre, string estado, global::System.Nullable<int> sucursal) {
            if ((usuario == null)) {
            ...
            if ((sucursal.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((int)(sucursal.Value));
            }
            else {
        ...
        public virtual int Update(string usuario, string contrasena, string nombre, string estado, global::System.Nullable<int> sucursal, string Original_usuario, string Original_contrasena, string Original_nombre, string Original_estado, global::System.Nullable<int> Original_sucursal) {
            if ((usuario == null)) {
                throw new global::System.ArgumentNullException("usuario");
            }
            else {
            ...
            if ((sucursal.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(sucursal.Value));
            }
            else {
            ...
            if ((Original_sucursal.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_sucursal.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string contrasena, string nombre, string estado, global::System.Nullable<int> sucursal, string Original_usuario, string Original_contrasena, string Original_nombre, string Original_estado, global::System.Nullable<int> Original_sucursal) {
            return this.Update(Original_usuario, contrasena, nombre, estado, sucursal, Original_usuario, Original_contrasena, Original_nombre, Original_estado, Original_sucursal);
        }
    }
