...
namespace DjProyect {
    ...
    public partial class departamentoDataSet : global::System.Data.DataSet {
        ...
        public partial class departamentoDataTable : global::System.Data.TypedTableBase<departamentoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public departamentoRow AdddepartamentoRow(int codigo, string nombre) {
...
namespace DjProyect.departamentoDataSetTableAdapters {
    ...
    public partial class departamentoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[departamento] WHERE (([codigo] = @Original_codigo) AND ([nombr" +
                "e] = @Original_nombre))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[departamento] ([codigo], [nombre]) VALUES (@codigo, @nombre);\r" +
                "\nSELECT codigo, nombre FROM departamento WHERE (codigo = @codigo)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[departamento] SET [codigo] = @codigo, [nombre] = @nombre WHERE (([c" +
                "odigo] = @Original_codigo) AND ([nombre] = @Original_nombre));\r\nSELECT codigo, n" +
                "ombre FROM departamento WHERE (codigo = @codigo)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT codigo, nombre FROM dbo.departamento";
